<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <String label="UserAddress" v-model="item.userAddress" :editMode="editMode" @change="change" />
            </div>
            <div>
            ...
            <div>
                <Number label="OrderAmt" v-model="item.orderAmt" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Number label="PaymentAmt" v-model="item.paymentAmt" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Number label="RefundAmt" v-model="item.refundAmt" :editMode="editMode" @change="change" />
            </div>
        </v-card-text>
