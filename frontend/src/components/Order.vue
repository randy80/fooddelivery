<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-text>
            ...
            <String label="UserAddress" v-model="value.userAddress" :editMode="editMode"/>
            ...
            <Number label="OrderAmt" v-model="value.orderAmt" :editMode="editMode"/>
            <Number label="PaymentAmt" v-model="value.paymentAmt" :editMode="editMode"/>
            <Number label="RefundAmt" v-model="value.refundAmt" :editMode="editMode"/>
        </v-card-text>
    ...
    export default {
        ...
        methods: {
            ...
            async payments() {
                try {
                    if(!this.offline) {
                        var temp = await axios.put(axios.fixUrl(this.value._links['payments'].href))
